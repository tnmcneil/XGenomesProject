...
####################################################
################Adjustable Features#################
set_name = "Set_regen"  # Input training data folder   ./set_name
Model_name = "Set_regen"  # Output model name  ./set_name/Model_name
...
Image_size = [640,160] # [height,width]

pooling_size = [8,4] # downsampling factor

Conv_Kernal_1 = [100,20] # First convolution kernal
...
h_pool1 = max_pool_def(h_conv1,pooling_size)
...
h_pool2 = max_pool_def(h_conv2,pooling_size)

print("Building First Fully connected layer")
w_fc1 = weight_variable([Image_size[0]//(pooling_size[0]*pooling_size[0]) * Image_size[1]//(pooling_size[1]*pooling_size[1]) * Conv_Feature_2, Ful_Feature])
b_fc1 = bias_variable([Ful_Feature])
h_pool2_flat = tf.reshape(h_pool2, [-1, Image_size[0]//(pooling_size[0]*pooling_size[0]) * Image_size[1]//(pooling_size[1]*pooling_size[1]) * Conv_Feature_2])
